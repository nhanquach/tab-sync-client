        ...
        <div className={cn(
          ...
          <div className="flex-none">
            <Tooltip>
              ...
              <TooltipContent>Refresh tabs</TooltipContent>
            </Tooltip>
          </div>
          ...
          <div className={cn(
            ...
            {isScrolled && !isSearchExpanded ? (
              <Tooltip>
                ...
                <TooltipContent>Expand search</TooltipContent>
              </Tooltip>
            ) : (
              <div className={cn(
                ...
                <Input
                  ...
                  aria-label="Search your synced tabs"
                  className={cn(
            ...
            {isScrolled && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    aria-label={`Selected device: ${selectedDevice}`}
            ...
            <div className={cn(
              ...
              {toggleSelectionMode && (
                <Tooltip>
                  ...
                  <TooltipContent>Toggle selection mode</TooltipContent>
                </Tooltip>
              )}
            </div>
          </div>
